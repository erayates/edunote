...
export const GEMINI_API_SEARCH_URL = process.env.NEXT_PUBLIC_GEMINI_API_SEARCH_URL;
export const GEMINI_API_YOUTUBE_URL = process.env.NEXT_PUBLIC_GEMINI_API_YOUTUBE_URL;
