...
export function AISelector({ onOpenChange }: AISelectorProps) {
  ...
  return (
    <Command className="w-[350px] bg-foreground">
      ...
      {isLoading && (
        <div className="flex h-12 w-full items-center px-4 text-sm font-medium text-muted-foreground text-red-500">
      ...
      {!isLoading && (
        <>
          <div className="relative">
            ...
            <Button
              size="icon"
              className="absolute right-2 top-1/2 h-6 w-6 -translate-y-1/2 rounded-full bg-red-500 hover:bg-red-600"
              onClick={() => {
                if (completion)
